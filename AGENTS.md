...
> Python CLI toolkit per qualita vault Markdown: 18+ comandi, MCP server (4 tool stdio), zero-deps core. Obsidian plugin companion.
...
src/
  marginalia/            # Python CLI package
    mcp_server.py        # MCP server — 4 tools: scan_status, query_tags, get_related, list_orphans
